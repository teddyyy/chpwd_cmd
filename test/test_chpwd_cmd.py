...
import chpwd_cmd
from src.color import green, red
...
class TestChpwdCmd:
    ...
    def setup(self):
        ...
        del sys.argv[1:]
        chpwd_cmd.ConfigFile.CONFIG_FILE_PATH = 'test/.test_chpwd_cmd'

    # error
    @raises(SystemExit)
    @with_setup(setup=setup)
    def test_no_configuration(self):
        chpwd_cmd.ConfigFile.CONFIG_FILE_PATH = 'test/.no_chpwd_cmd'
    ...
    def test_chpwd_exec_command_exception(self):
        chpwd_cmd.ConfigFile.CONFIG_FILE_PATH = 'test/.test_command_exception'
